        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use border utilities to add or remove an element’s borders.
                        ...
                        <div>
                            <div>
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    ...
                                    <div class="text-center">
                                        <img src="build/images/small/img-2.jpg"
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use below-mentioned class to an element to display the value
                    ...
                    <div class="live-preview">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-muted">Change the display value of elements when printing
    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Use the object fit utilities to modify how the content of
                        a replaced element, such as an <code>&lt;img&gt;</code> or
                        <code>&lt;video&gt;</code>, should be resized to fit its container.
                    </p>
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="text-center">
                                <img src="build/images/small/img-3.jpg" alt="" height="230"
                                    width="200" class="rounded object-fit-cover">
                        ...
                        <div class="col-lg-2">
                            <div class="text-center">
                                <img src="build/images/small/img-3.jpg" alt="" height="230"
                                    width="200" class="rounded object-fit-contain border">
                        ...
                        <div class="col-lg-2">
                            <div class="text-center">
                                <img src="build/images/small/img-3.jpg" alt="" height="230"
                                    width="200" class="rounded object-fit-fill border">
                        ...
                        <div class="col-lg-2">
                            <div class="text-center">
                                <img src="build/images/small/img-3.jpg" alt="" height="230"
                                    width="200" class="rounded object-fit-scale border">
                        ...
                        <div class="col-lg-2">
                            <div class="text-center">
                                <img src="build/images/small/img-3.jpg" alt="" height="230"
                                    width="200" class="rounded object-fit-none">
    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Use our low-level <code>z-index</code> utilities to
                        quickly change the stack level of an element or component.</p>
                    <div class="position-relative z-1">
                        <img src="build/images/users/avatar-1.jpg" alt=""
                            class="avatar-xl rounded position-relative z-n1">
                        <img src="build/images/users/avatar-2.jpg" alt=""
                            class="avatar-xl rounded position-relative z-0 ms-n5 mt-5">
                        <img src="build/images/users/avatar-3.jpg" alt=""
                            class="avatar-xl rounded position-relative z-1 ms-n5">
                        <img src="build/images/users/avatar-4.jpg" alt=""
                            class="avatar-xl rounded position-relative z-2 ms-n5 mt-5">
                        <img src="build/images/users/avatar-5.jpg" alt=""
                            class="avatar-xl rounded position-relative z-3 ms-n5">
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>overflow</code> property on the fly with four
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use below mentioned classes to arrange elements easily with
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">While shadows on components are disabled by default in
