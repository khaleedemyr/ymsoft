            ...
            <div class="card-body z-1 position-relative">
                <div class="d-sm-block d-md-flex">
                    <div class="flex-grow-1">
                        <img src="build/images/logo-dark.png" class="card-logo-dark" alt="logo dark" height="28">
                        <img src="build/images/logo-light.png" class="card-logo-light" alt="logo light" height="28">
                    </div>
                    <div class="flex-shrink-0 mt-sm-0 mt-3">
                        <h6><span class="text-muted fw-normal">Legal Registration No:</span> <span id="legal-register-no">32654 9851</span></h6>
                        <h6><span class="text-muted fw-normal">Email:</span> <span id="email">vixon@themesbrand.com</span></h6>
                ...
                <div class="mt-5 pt-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                <p class="text-muted text-uppercase mb-2">Billing Address</p>
                        ...
                        <div class="col-md-4">
                            <div>
                                <p class="text-muted text-uppercase mb-2">Shipping Address</p>
                ...
                <div>
                    ...
                    <div class="invoice-signature text-center">
                        <img src="build/images/invoice-signature.svg" alt="" id="sign-img" height="30">
