...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-tabs</code> class to generate a default tabbed
                    interface.</p>
                <!-- Nav tabs -->
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-justified</code> class to generate equal-width
                    elements with all horizontal space will be occupied by nav links.</p>
                <!-- Nav tabs -->
...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-pills</code> class to generate particular
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-pills nav-justified</code> class to generate
...
<div class="row">
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-tabs-custom</code> class to create custom tabs
                    with borders.</p>
                <!-- Nav tabs -->
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>arrow-navtabs </code>class to create arrow nav tabs.
                </p>
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="arrow-overview" role="tabpanel">
                        ...
                        <p class="mb-0">
                            ...
                            hours to create a <a href="javascript:void(0);" class="text-decoration-underline"><b>Fantastic Design</b></a> by
                            using complicated 3D elements. Flat design is your friend. Remember
                            that. And the great thing about flat design is that it has become more
                    ...
                    <div class="tab-pane" id="arrow-profile" role="tabpanel">
                        ...
                        <p class="mb-0">
                            ...
                            interested in the unusual, and that’s why using contrasting colors in <a href="javascript:void(0);" class="text-decoration-underline"><b>Graphic Design</b></a> is a
                            must. It’s eye-catching, it makes a statement, it’s impressive graphic
                    ...
                    <div class="tab-pane" id="arrow-contact" role="tabpanel">
                        ...
                        <p class="mb-0">
                            ...
                            excellent news to the beginner and advanced <a href="javascript:void(0);" class="text-decoration-underline"><b>Contact Designer</b></a>.
                        </p>
                    </div>
                </div>
            </div><!-- end card-body -->
...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-header align-items-xl-center d-xl-flex">
                <p class="text-muted flex-grow-1 mb-xl-0">Use <code>card-header-pills</code> class
                    ...
                    <div class="tab-pane active" id="developers" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-8.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                ...
                                <div class="d-flex mt-3">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-7.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex mt-3">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-6.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex mt-3">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex mt-3">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                    ...
                    <div class="tab-pane" id="designers" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex mt-3">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>card-footer-tabs</code> class to create the bottom
                    card nav justify tab.</p>
                <div class="tab-content text-muted">
...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>custom-hover-nav-tabs</code> class to create custom
                    hover tabs.</p>
            </div>
            <div class="border">
                        ...
                        <div class="tab-content text-muted mt-3 mt-lg-0">
                            <div class="tab-pane fade active show" id="custom-v-pills-home" role="tabpanel" aria-labelledby="custom-v-pills-home-tab">
                                <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-4.jpg" alt="" width="150" class="rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <p class="mb-0">Experiment and play around with the fonts
                                            that you already have in the software you’re working
                                            with reputable font websites. commodo enim craft beer
                                ...
                                <div class="d-flex">
                                    <div class="flex-grow-1 me-3">
                                        <p class="mb-0">Always want to make sure that your fonts
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-5.jpg" alt="" width="150" class="rounded">
                                    </div>
                                </div>
                            </div>
                            <!--end tab-pane-->
                            <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-3.jpg" alt="" width="150" class="rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <p class="mb-0">In some designs, you might adjust your
                                ...
                                <div class="d-flex">
                                    <div class="flex-grow-1 me-3">
                                        <p class="mb-0">Each design is a new, unique piece of art
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-6.jpg" alt="" width="150" class="rounded">
                                    </div>
                                </div>
                            </div>
                            <!--end tab-pane-->
                            <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-7.jpg" alt="" width="150" class="rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex">
                                    <div class="flex-grow-1 me-3">
                                        <p class="mb-0">They all have something to say beyond the
                                            words on the page. They can come across as casual or
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="build/images/small/img-8.jpg" alt="" width="150" class="rounded">
                                    </div>
                                </div>
                            </div>
                            <!--end tab-pane-->
...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>animation-nav</code> class to create animated tabs.
                </p>
                <!-- Nav tabs -->
...
<div class="row">
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Use <code>nav-border-top</code> class to create nav tabs with
                    border at top.</p>
                <!-- Nav tabs -->
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-body">
                <p class="text-muted">*Use <code>nav-custom-</code> class with modifier class to
                    color tabs.</p>
                <!-- Nav tabs -->
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="nav-colored-home" role="tabpanel">
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img src="build/images/users/avatar-2.jpg" alt="" class="avatar-md rounded">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <img src="build/images/users/avatar-3.jpg" alt="" class="avatar-md rounded">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="nav-colored-profile" role="tabpanel">
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img src="build/images/users/avatar-4.jpg" alt="" class="avatar-md rounded">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <img src="build/images/users/avatar-1.jpg" alt="" class="avatar-md rounded">
                            </div>
                        </div>
                    </div>
