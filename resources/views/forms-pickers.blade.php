                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                ...
                                <p class="text-muted">Set <code>data-provider="flatpickr" data-date-format="d M, Y" data-default-date="Your Default Date"</code> attribute.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                ...
                                <p class="text-muted">Set <code>data-provider="flatpickr" data-date-format="d M, Y" data-default-date="today" data-inline-date="true"</code> attribute.</p>
