...
@section('title')
    @lang('translation.subcategory.title')
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card" id="subcategoryList">
                        <div class="card-header d-flex align-items-center">
                            <h6 class="card-title flex-grow-1 mb-0">@lang('translation.subcategory.list')</h6>
                            <div class="flex-shrink-0">
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <div class="search-box">
                                        <input type="text" class="form-control search" placeholder="Cari sub kategori...">
                                    </div>
                                    <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#modal-subcategory">
                                        <i class="ri-add-line align-bottom me-1"></i> @lang('translation.subcategory.add')
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card mb-1">
                                    <table id="datatable" class="table align-middle table-nowrap">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>@lang('translation.subcategory.category')</th>
                                                <th>@lang('translation.subcategory.name')</th>
                                                <th>@lang('translation.subcategory.description')</th>
                                                <th>@lang('translation.category.status')</th>
                                                <th>@lang('translation.subcategory.action')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-{{ $subCategory->status == 'active' ? 'success' : 'danger' }}">
                                                        {{ $subCategory->status == 'active' ? __('translation.category.active') : __('translation.category.inactive') }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button class="btn btn-sm btn-link text-{{ $subCategory->status == 'active' ? 'danger' : 'success' }} toggle-status-btn"
                                                                data-id="{{ $subCategory->id }}"
                                                                data-status="{{ $subCategory->status }}">
                                                            <i class="ti ti-{{ $subCategory->status == 'active' ? 'ban' : 'check' }} fs-5"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
...
<!-- Modal -->
<div class="modal fade" id="modal-subcategory" tabindex="-1" aria-labelledby="modal-title" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">@lang('translation.subcategory.add')</h5>
            ...
            <form id="subcategoryForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">@lang('translation.subcategory.category')</label>
                        <select class="form-select" id="category_id" name="category_id" required>
                            <option value="">@lang('translation.subcategory.select_category')</option>
                    ...
                    <div class="mb-3">
                        <label class="form-label">@lang('translation.subcategory.name')</label>
                        <input type="text" class="form-control" id="name" name="name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">@lang('translation.subcategory.description')</label>
                        <textarea class="form-control" id="description" name="description"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">@lang('translation.subcategory.close')</button>
                    <button type="submit" class="btn btn-primary">@lang('translation.subcategory.save')</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#subcategoryForm').on('submit', function(e) {
                ...
                let url = id ? `/sub-categories/${id}` : '/sub-categories';
            ...
            $(document).on('click', '.edit-btn', function() {
                $('#modal-title').text('@lang("translation.subcategory.edit")');
        ...
        $('#modal-subcategory').on('hidden.bs.modal', function () {
            ...
            $('#subcategory_id').val('');
            $('#modal-title').text('@lang("translation.subcategory.add")');
        });
    </script>
