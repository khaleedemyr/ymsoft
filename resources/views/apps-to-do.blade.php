...
@section('title') @lang('translation.todolists') @endsection
@section('css')
...
<div class="chat-wrapper d-lg-flex gap-3 gap-lg-4 p-xl-1 pt-md-5 p-lg-1">
    <div class="todo-sidebar">
        <div class="d-flex flex-column h-100 p-3">
            ...
            <div class="px-4 mx-n4" data-simplebar style="height: 560px;">
                <ul class="to-do-menu list-unstyled" id="projectlist-data">
                    <li>
                        <a data-bs-toggle="collapse" href="#vixonAdmin" class="nav-link fs-13">Vixon Admin & Dashboard</a>
                        <div class="collapse show" id="vixonAdmin">
                            <ul class="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                ...
                                <li>
                                    <a href="#!"><i class="ri-stop-mini-fill align-middle fs-15 text-primary"></i> v1.3.0</a>
                                </li>
                                <li>
                                    <a href="#!"><i class="ri-stop-mini-fill align-middle fs-15 text-warning"></i> v1.4.0</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li>
                        <a data-bs-toggle="collapse" href="#skoteAdmin" class="nav-link fs-13">Steex Admin & Dashboard</a>
                        <div class="collapse show" id="skoteAdmin">
                            <ul class="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                <li>
                                    <a href="#!"><i class="ri-stop-mini-fill align-middle fs-15 text-danger"></i> v1.0.0</a>
                                </li>
                                <li>
                                    <a href="#!"><i class="ri-stop-mini-fill align-middle fs-15 text-secondary"></i> v1.2.0</a>
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="mt-auto text-center">
                <div class="card mt-4">
                    <div class="card-body pt-0">
                        ...
                        <a href="pages-pricing" class="btn btn-primary w-100">Upgrade Now</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <div class="select-element">
                            <button class="btn btn-light w-100 d-flex justify-content-between" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <span>Assigned To<b id="total-assignee" class="mx-1">0</b>Members</span> <i class="ti ti-chevron-down"></i>
                            </button>
                                ...
                                <div data-simplebar style="max-height: 141px">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="build/images/users/avatar-10.jpg" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="build/images/users/avatar-9.jpg" alt="" class="img-fluid rounded-circle" />
                                                </div>
