            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-muted fs-sm">Alexandra</td>
                                    </tr>
                                    <tr>
                                        <th class="ps-0 fs-md" scope="row">Mobile :</th>
                                        <td class="text-muted fs-sm">+(1) 987 6543</td>
                                    </tr>
                                    <tr>
                                        <th class="ps-0 fs-md" scope="row">E-mail :</th>
                                        <td class="text-muted fs-sm">alexandra@vixon.com</td>
                                    </tr>
                                    <tr>
                                        <th class="ps-0 fs-md" scope="row">Location :</th>
                                        <td class="text-muted fs-sm">California, United States
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="ps-0 fs-md" scope="row">Joining Date :</th>
                                        <td class="text-muted fs-sm">24 May 2023</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="py-3 border-top border-dashed">
                        <h5 class="card-title mb-3">Comp Picture</h5>
                        <div class="row">
                            <div class="col-3">
                                <img src="build/images/small/img-2.jpg" alt="" class="img-fluid rounded">
                            </div>
                            <div class="col-3">
                                <img src="build/images/small/img-10.jpg" alt="" class="img-fluid rounded">
                            </div>
                            <div class="col-3">
                                <img src="build/images/small/img-11.jpg" alt="" class="img-fluid rounded">
                            </div>
                            <div class="col-3">
                                <img src="build/images/small/img-12.jpg" alt="" class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="py-3 border-top border-dashed">
                            ...
                            <div class="flex-shrink-0">
                                <div class="dropdown">
                                    <a href="#" role="button" id="dropdownMenuLink2" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-2-fill fs-md"></i>
                                    </a>
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center py-3">
                                <div class="avatar-xs flex-shrink-0 me-3">
                                    <img src="build/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                                    <div>
                    ...
                    <div class="pt-3 border-top border-dashed">
                        ...
                        <div class="d-flex mb-4">
                            <div class="flex-shrink-0">
                                <img src="build/images/small/img-4.jpg" alt="" height="50" class="rounded">
                            </div>
                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                <a href="javascript:void(0);">
                                    <h6 class="text-truncate fs-md">Design your apps in your own way</h6>
                                </a>
                                <p class="text-muted fs-sm mb-0">15 Dec 2021</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="flex-shrink-0">
                                <img src="build/images/small/img-5.jpg" alt="" height="50" class="rounded">
                            </div>
                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                <a href="javascript:void(0);">
                                    <h6 class="text-truncate fs-md">Smartest Applications for Business</h6>
                                </a>
                                <p class="text-muted fs-sm mb-0">28 Nov 2021</p>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="build/images/small/img-6.jpg" alt="" height="50" class="rounded">
                            </div>
                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                <a href="javascript:void(0);">
                                    <h6 class="text-truncate fs-md">How to get creative in your work</h6>
                                </a>
                                <p class="text-muted fs-sm mb-0">21 Nov 2021</p>
                            </div>
                        </div>
                    </div>
                </div><!-- end card body -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-md">Hi I'm Alexandra, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</p>
                                    <p class="text-muted fs-md">You always want to make sure that your fonts work well together and try to limit the number of fonts you use to three or less. Experiment and play around with the fonts that you already have in the software you’re working with reputable font websites. This may be the most commonly encountered tip I received from the designers I spoke with. They highly encourage that you use different fonts in one design, but do not over-exaggerate and go overboard.</p>
                                    <div class="row">
                                        <div class="col-6 col-md-4">
                                            <div class="d-flex mt-4">
                                                <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    <div class="avatar-title bg-primary-subtle rounded fs-16 text-primary">
                                                        <i class="ri-user-2-fill"></i>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-muted fs-md mb-1">Designation :</p>
                                                    <h6 class="text-truncate fs-sm mb-0">Lead Designer / Developer</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-md-4">
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-muted fs-md mb-0">Website :</p>
                                                    <a href="#" class="fw-semibold fs-sm">www.vixon.com</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end col-->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header align-items-center d-flex flex-wrap flex-column flex-sm-row">
                                            <h4 class="card-title mb-0  me-2">Recent Activity</h4>
                                            <div class="flex-shrink-0 ms-sm-auto mt-4 mt-sm-0">
                                                <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link fs-md active" data-bs-toggle="tab" href="#today" role="tab">
                                                            Today
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link fs-md" data-bs-toggle="tab" href="#weekly" role="tab">
                                                            Weekly
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link fs-md" data-bs-toggle="tab" href="#monthly" role="tab">
                                                            Monthly
                                                        </a>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <div class="accordion accordion-flush" id="todayExample">
                                                            <div class="accordion-item border-0">
                                                                ...
                                                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body fs-md ms-2 ps-5">
                                                                ...
                                                                <div class="accordion-header" id="headingThree">
                                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapsethree" aria-expanded="false">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="flex-grow-1 ms-3">
                                                                                <h6 class="fs-md mb-1"> New ticket received</h6>
                                                            ...
                                                            <div class="accordion-item border-0">
                                                                ...
                                                                <div id="collapseFour" class="accordion-collapse collapse show" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body fs-md ms-2 ps-5 fst-italic">
                                                            ...
                                                            <div class="accordion-item border-0">
                                                                <div class="accordion-header" id="headingFive">
                                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                                                        <div class="d-flex">
                                                                            <div class="flex-shrink-0">
                                                                                <img src="build/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle">
                                                                            </div>
                                                                            <div class="flex-grow-1 ms-3">
                                                                                <h6 class="fs-md mb-1">
                                                                                    Lewis Arnold
                                                                ...
                                                                <div id="collapseFive" class="accordion-collapse collapse show" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body fs-md ms-2 ps-5">
                                                                        <p class="text-muted mb-2"> Every team project can have a vixon. Use the vixon to share information with your team to understand and contribute to your project.</p>
                                                                ...
                                                                <div class="accordion-header" id="heading8">
                                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse8" aria-expanded="true">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="flex-grow-1 ms-3">
                                                                                <h6 class="fs-md mb-1">
                                                                                    vixon admin dashboard templates layout upload
                                                                                </h6>
                                                                        ...
                                                                        <div class="row mt-2">
                                                                            <div class="col-xxl-6">
                                                                                <div class="row border border-dashed gx-2 p-2">
                                                                                    ...
                                                                                    <!--end col-->
                                                                                    <div class="col-3">
                                                                                        <img src="build/images/small/img-5.jpg" alt="" class="img-fluid rounded">
                                                                                    </div>
                                                                                    <!--end col-->
                                                                                    <div class="col-3">
                                                                                        <img src="build/images/small/img-7.jpg" alt="" class="img-fluid rounded">
                                                                                    </div>
                                                                                    <!--end col-->
                                                                                    <div class="col-3">
                                                                                        <img src="build/images/small/img-9.jpg" alt="" class="img-fluid rounded">
                                                                                    </div>
                                                                                    <!--end col-->
                                                                                </div>
                                                                                <!--end row-->
                                                                ...
                                                                <div id="collapse10" class="accordion-collapse collapse show" aria-labelledby="heading10" data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body fs-md ms-2 ps-5">
                                                                        <p class="text-muted fst-italic mb-2">
                                                                            " This is an awesome admin dashboard template. It is extremely well structured and uses state of the art components (e.g. one of the only templates using bootstrap 5.1.3 so far). I integrated it into a Rails 6 project. Needs manual integration work of course but the template structure made it easy. "</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div id="collapse15" class="accordion-collapse collapse show" aria-labelledby="heading15" data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body fs-md ms-2 ps-5">
                                                                        <p class="text-muted mb-2">
                                                                            Every team project can have a vixon. Use the vixon to share information with your team to understand and contribute to your project.</p>
                                                                        <div class="avatar-group">
                                                                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                                                <img src="build/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                                                                            </a>
                            ...
                            <div class="acitivity-timeline">
                                <div class="acitivity-item d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted fs-md mb-2">We talked about a project on linkedin.</p>
                                        <small class="mb-0 text-muted">Today</small>
                                    </div>
                                </div>
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0 avatar-xs acitivity-avatar rounded-circle">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted fs-md"><i class="ri-file-text-line align-middle ms-2"></i> Create new project Buildng product</p>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted fs-md">Adding a new event with attachments</p>
                                        <div class="row">
                                            <div class="col-xxl-4">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">Bethany Johnson</h6>
                                        <p class="text-muted fs-md mb-2">added a new member to vixon dashboard</p>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted fs-md mb-2">These customers can rest assured their order has been placed.</p>
                                        <small class="mb-0 text-muted">16 Nov</small>
                                    </div>
                                </div>
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">Lewis Pratt</h6>
                                        <p class="text-muted fs-md mb-2">They all have something to say
                                ...
                                <div class="acitivity-item d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="build/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">New ticket received <span class="badge bg-success-subtle text-success align-middle">Completed</span></h6>
                                        <p class="text-muted fs-md mb-2">User <span class="text-secondary">Erica245</span> submitted a ticket.</p>
