            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="monthly_profit"
                                data-colors='["--tb-primary", "--tb-info", "--tb-warning", "--tb-success"]'
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="column_stacked_chart" data-colors='["--tb-primary", "--tb-success"]'
                                class="apex-charts" dir="ltr"></div>
                        </div>
                    </div>
                    <!--end col-->
        ...
        <div class="col-xl-7">
            <div class="card">
                ...
                <div class="card-body ps-0">
                    <div id="customer_impression_charts" data-colors='["--tb-secondary", "--tb-success", "--tb-danger"]'
                        class="apex-charts" dir="ltr"></div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card bg-body-secondary border-0">
                            <div class="card-body p-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-muted fs-md mb-0"><a href="#!"
                                            class="text-reset text-decoration-underline">Watches</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-body-secondary border-0">
                            <div class="card-body p-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-muted fs-md mb-0"><a href="#!"
                                            class="text-reset text-decoration-underline">Fashion & Clothing</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-body-secondary border-0">
                            <div class="card-body p-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    <h6 class="text-truncate"><a href="#!">Striped High Neck Casual Men Orange
                                            Sweater</a></h6>
                                    <p class="text-muted fs-md mb-0"><a href="#!"
                                            class="text-reset text-decoration-underline">Fashion & Clothing</a></p>
                                </div>
                ...
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown">
                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <span class="fw-semibold text-uppercase fs-sm">Sort by: </span><span
                                    class="text-muted">Today<i class="ti ti-chevron-down ms-1"></i></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="#">Today</a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-1.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">Rockerz Ear
                                                    Bluetooth Headphones</a></div>
                                        </div>
                                    </td>
                                    <td>16 Aug, 2022</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-5.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">United Colors
                                                    Of Benetton</a></div>
                                        </div>
                                    </td>
                                    <td>05 Sep, 2022</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-4.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">Striped
                                                    Baseball Cap</a></div>
                                        </div>
                                    </td>
                                    <td>28 Sep, 2022</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-3.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">350 ml Glass
                                                    Grocery Container</a></div>
                                        </div>
                                    </td>
                                    <td>02 Oct, 2022</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-2.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">One Seater
                                                    Sofa</a></div>
                                        </div>
                                    </td>
                                    <td>11 Oct, 2022</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="build/images/products/img-8.png" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="#" class="text-reset">Men's Running
                                                    Shoes Active Grip</a></div>
                                        </div>
                                    </td>
                                    <td>19 Nov, 2022</td>
                                    <td>
