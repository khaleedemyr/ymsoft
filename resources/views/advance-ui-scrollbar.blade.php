                        ...
                        <div class="mx-n3">
                            <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary" style="max-height: 275px;">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            <div class="fs-xs text-muted">
                                                <i class="ti ti-clock-hour-4"></i> 30 min ago
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-xs me-3">
                                            <img src="build/images/users/avatar-2.jpg" class="rounded-circle img-fluid" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1 text-muted">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            <div class="fs-xs text-muted">
                                                <i class="ti ti-clock-hour-4"></i> 01 hr ago
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            <div class="fs-xs text-muted">
                                                <i class="ti ti-clock-hour-4"></i> 02 hrs ago
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-xs me-3">
                                            <img src="build/images/users/avatar-8.jpg" class="rounded-circle img-fluid" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1 text-muted">
                                ...
                                <div class="text-center my-2">
                                    <a href="javascript:void(0);" class="text-success"><i class="ti ti-refresh fs-3xl align-middle me-2"></i> Load more </a>
                                </div>
                            </div>
                        </div>
                    </div><!-- end card-body -->
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div>
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="badge bg-success bg-gradient mb-2"><i class="ti ti-star"></i> 4.1</div>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <li class="list-group-item">
                                        <div>
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="badge bg-success bg-gradient mb-2"><i class="ti ti-star"></i> 4.0</div>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <li class="list-group-item">
                                        <div>
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="badge bg-success bg-gradient mb-2"><i class="ti ti-star"></i> 4.2</div>
                                                </div>
                                                <div class="flex-shrink-0">
