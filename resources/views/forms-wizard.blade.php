                            ...
                            <div>
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                        <img src="build/images/users/user-dummy-img.jpg" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
            ...
            <div class="card-body form-steps">
                <form action="#">
                    <a class="navbar-brand d-block text-center pt-3 pb-4 mb-1" href="#">
                        <img src="build/images/logo-dark.png" class="card-logo mx-auto card-logo-dark" alt="logo dark" height="22">
                        <img src="build/images/logo-light.png" class="card-logo mx-auto card-logo-light" alt="logo light" height="22">
                    </a>
