            ...
            <div class="card-body">
                ...
                <div class="swiper navigation-swiper rounded">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img src="build/images/small/img-6.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="swiper pagination-dynamic-swiper rounded">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="build/images/small/img-7.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="swiper-slide">
                            <img src="build/images/small/img-8.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="swiper-slide">
                            <img src="build/images/small/img-9.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="swiper pagination-fraction-swiper rounded">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="build/images/small/img-10.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="swiper-slide">
                            <img src="build/images/small/img-11.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="swiper-slide">
                            <img src="build/images/small/img-12.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="swiper-button-next"></div>
                    <div class="swiper-button-prev"></div>
                ...
                <div class="swiper responsive-swiper rounded gallery-light pb-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-box card">
                                <div class="gallery-container">
                                    <a class="image-popup" href="build/images/small/img-1.jpg" title="">
                                        <img class="gallery-img img-fluid mx-auto" src="build/images/small/img-1.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-box card">
                                <div class="gallery-container">
                                    <a class="image-popup" href="build/images/small/img-2.jpg" title="">
                                        <img class="gallery-img img-fluid mx-auto" src="build/images/small/img-2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="box-content px-3 py-2">
                                    <div class="gallery-overlay">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-box card mb-0">
                                <div class="gallery-container">
                                    <a class="image-popup" href="build/images/small/img-10.jpg" title="">
                                        <img class="gallery-img img-fluid mx-auto" src="build/images/small/img-10.jpg" alt="">
                                    </a>
                                </div>
                                <div class="box-content px-3 py-2">
                                    <div class="gallery-overlay">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-box card">
                                <div class="gallery-container">
                                    <a class="image-popup" href="build/images/small/img-4.jpg" title="">
                                        <img class="gallery-img img-fluid mx-auto" src="build/images/small/img-4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="box-content px-3 py-2">
                                    <div class="gallery-overlay">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-box card">
                                <div class="gallery-container">
                                    <a class="image-popup" href="build/images/small/img-6.jpg" title="">
                                        <img class="gallery-img img-fluid mx-auto" src="build/images/small/img-6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="box-content px-3 py-2">
                                    <div class="gallery-overlay">
