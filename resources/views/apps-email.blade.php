...
<div class="email-wrapper d-lg-flex gap-1 mx-n3 mt-n3 p-1">
    ...
    <div class="email-menu-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                <div class="mail-list mt-3 fs-md">
                ...
                <div>
                    ...
                    <div class="mail-list fs-md mt-1">
                        <a href="#"><span class="ri-checkbox-blank-circle-fill fs-xs me-2 text-info"></span><span class="mail-list-link" data-type="label">Support</span> <span class="badge bg-secondary-subtle text-secondary ms-auto">3</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-fill fs-xs me-2 text-warning"></span><span class="mail-list-link" data-type="label">Freelance</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-fill fs-xs me-2 text-primary"></span><span class="mail-list-link" data-type="label">Social</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-fill fs-xs me-2 text-danger"></span><span class="mail-list-link" data-type="label">Friends</span><span class="badge bg-secondary-subtle text-secondary ms-auto">2</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-fill fs-xs me-2 text-success"></span><span class="mail-list-link" data-type="label">Family</span></a>
                    </div>
                </div>

                <div class="d-block d-lg-none">
                    <div class="mb-4 d-flex align-items-center justify-content-between">
                        <h5 class="fs-xs text-uppercase text-muted mb-0">Chat</h5>
                        <a href="#" class="btn btn-icon btn-sm btn-subtle-info btn-rounded"><i class="ri-add-line fs-6"></i></a>
                    </div>

                    <div class="vstack email-chat-list mx-n4">
                        <a href="javascript: void(0);" class="d-flex align-items-center active">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-2.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Scott Median</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Hello ! are you there?</small>
                            </div>
                        </a>

                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-4.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Julian Rosa</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">What about our next..</small>
                            </div>
                        </a>

                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-3.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">David Medina</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Yeah everything is fine</small>
                            </div>
                        </a>

                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-5.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Jay Baker</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Wow that's great</small>
                            </div>
                        </a>
                        <a href="javascript: void(0);" class="d-flex align-items-center active">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-6.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Lisa Parker</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Hello ! are you there?</small>
                            </div>
                        </a>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-7.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Frank Thomas</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">What about our next..</small>
                            </div>
                        </a>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-8.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Crifford Taylor</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Yeah everything is fine</small>
                            </div>
                        </a>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="build/images/users/avatar-9.jpg" alt="">
                            </div>

                            <div class="flex-grow-1 chat-user-box overflow-hidden">
                                <h5 class="fs-md text-truncate mb-0 chatlist-user-name">Nellie Cornett</h5>
                                <small class="fs-sm text-muted text-truncate mb-0">Wow that's great</small>
                            </div>
                        </a>
                    </div>
    ...
    <div class="email-content">
        <div class="email-panel p-3 pt-4 d-none d-lg-flex align-items-center border-0">
            <div class="panel-list d-flex gap-4">
                <a href="apps-email" class="active"><i class="fs-md bi bi-envelope"></i> <span class="fs-md">Email</span></a>
                <a href="apps-chat"><i class="fs-md bi bi-chat-dots"></i> <span class="fs-md">Chat</span></a>
                <a href="apps-chat"><i class="fs-md bi bi-camera-video"></i> <span class="fs-md">Meet</span></a>
                <a href="apps-file-manager"><i class="fs-md bi bi-database"></i> <span class="fs-md">Storage</span></a>
            </div>
        </div>
        <div class="p-4 pb-0">
            ...
            <div>
                <div class="mail-primary">
                    <div class="message-list-content mx-n4 px-4 pb-3 message-list-scroll">
                        <div id="elmLoader">
    ...
    <div class="email-detail-content">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mx-n4 px-4 email-detail-content-scroll" data-simplebar>
                <div class="mt-4 mb-3">
                    <h5 class="fw-bold email-subject-title">New updates for Vixon Theme</h5>
                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="border rounded avatar-xl h-auto">
                                            <img src="build/images/small/img-2.jpg" alt="" class="img-fluid rouned-top">
                                            <div class="py-2 text-center">
                                                <a href="" class="d-block fw-semibold">Download</a>
                                            </div>
                                        </div>
                                        <div class="border rounded avatar-xl h-auto">
                                            <img src="build/images/small/img-6.jpg" alt="" class="img-fluid rouned-top">
                                            <div class="py-2 text-center">
                                                <a href="" class="d-block fw-semibold">Download</a>
                                            </div>
                                        </div>
                    ...
                    <div class="accordion-item border-dashed right">
                        <div class="accordion-header">
                            <a role="button" class="btn w-100 text-start px-0 bg-transparent shadow-none collapsed" data-bs-toggle="collapse" href="#email-collapseTwo" aria-expanded="true" aria-controls="email-collapseTwo">
                                <div class="d-flex align-items-center text-muted">
                                    <div class="flex-shrink-0 avatar-xs me-3">
                                        <img src="build/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
    ...
    <div class="email-menu-rightsidebar d-none d-lg-block">
        <div class="p-4 d-flex flex-column h-100" data-simplebar>
            <div class="mb-4 d-flex align-items-center justify-content-between">
                <h5 class="fs-xs text-uppercase text-muted mb-0">Chat</h5>
                <a href="#" class="btn btn-icon btn-sm btn-subtle-info btn-rounded"><i class="ri-add-line fs-6"></i></a>
            </div>
