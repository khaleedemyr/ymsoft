                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        <div class="text-center mt-5">
                                            ...
                                            <p class="text-muted">Sign in to continue to YMSoft.</p>
                                        </div>
                                        <div class="p-2 mt-5">
                                    ...
                                    <div class="card-body py-5 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="auth-effect-main my-5 position-relative rounded-circle d-flex align-items-center justify-content-center mx-auto">
                                            <div class="auth-user-list list-unstyled">
                                                <img src="build/images/auth/logojustusgroup.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-white opacity-75 mb-0 mt-3">
                                                ...
                                                </script> YMSoft. Crafted with <i class="ti ti-heart-filled text-danger"></i> by IT Department
                                            </p>
                                        </div>
                                    </div>
                                </div>
