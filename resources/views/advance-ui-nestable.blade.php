    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="list-group col nested-list nested-sortable">
                    <div class="list-group-item nested-1"> <i class="ti ti-folder fs-lg align-middle text-warning me-2"></i> assets
                        <div class="list-group nested-list nested-sortable">
                            <div class="list-group-item nested-2"> <i class="ti ti-folder fs-lg align-middle text-warning me-2"></i> css
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3"><i class="ti ti-file-description fs-lg align-middle text-secondary me-2"></i> style.css</div>
                                    <div class="list-group-item nested-3"><i class="ti ti-file-description fs-lg align-middle text-secondary me-2"></i> style.min.css</div>
                                </div>
                            </div>
                            <div class="list-group-item nested-2"> <i class="ti ti-folder fs-lg align-middle text-warning me-2"></i> Images
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3"><i class="ti ti-photo fs-lg align-middle text-info me-2"></i> logo.png</div>
                                </div>
                            </div>
                            <div class="list-group-item nested-2"> <i class="ti ti-folder fs-lg align-middle text-warning me-2"></i> js
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3"><i class="ti ti-brand-javascript fs-lg align-middle text-warning me-2"></i> app.js</div>
                                </div>
                            </div>
                            <div class="list-group-item nested-2"> <i class="ti ti-brand-html5 fs-lg align-middle text-danger me-2"></i> index.html</div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="list-group nested-list nested-sortable">
                    <div class="list-group-item nested-1"> <i class="ri-dashboard-2-line fs-lg align-middle text-primary me-2"></i> Dashboards
                        <div class="list-group nested-list nested-sortable">
                            <div class="list-group-item nested-2">Analytics</div>
                            <div class="list-group-item nested-2">CRM</div>
                        </div>
                    </div>
                    <div class="list-group-item nested-1"> <i class="ri-apps-2-line fs-lg align-middle text-primary me-2"></i> Apps
                        <div class="list-group nested-list nested-sortable">
                    ...
                    <div class="list-group-item nested-1"> <i class="ri-account-circle-line fs-lg align-middle text-primary me-2"></i> Authentication
                        <div class="list-group nested-list nested-sortable">
                    ...
                    <div class="list-group-item nested-1">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fs-md mb-0">Daryl Wolcott</h5>
                                <p class="text-muted fs-sm mb-0">CEO</p>
                            </div>
                        </div>
                        <div class="list-group nested-list nested-sortable">
                            <div class="list-group-item nested-2">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-xs flex-shrink-0 me-3">
                                        <img src="build/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="flex-grow-1">
                                        <h5 class="fs-md mb-0">Jacob Stanfield</h5>
                                ...
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="fs-md mb-0">David Houser</h5>
                                                <p class="text-muted fs-sm mb-0">Lead Designer</p>
                                            </div>
                                        </div>
                                        <div class="list-group nested-list nested-sortable">
                                            <div class="list-group-item nested-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-md mb-0">Jame Baker</h5>
                                                        <p class="text-muted fs-sm mb-0">UI/UX Designer</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="fs-md mb-0">Mickie Reyes</h5>
                                                <p class="text-muted fs-sm mb-0">Frontend Developer</p>
                                            </div>
                                        </div>
                                        <div class="list-group nested-list nested-sortable">
                                            <div class="list-group-item nested-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-md mb-0">Thomas Perez</h5>
                                                        <p class="text-muted fs-sm mb-0">Developer</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="list-group-item nested-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-md mb-0">Kim Wilson</h5>
                                                        <p class="text-muted fs-sm mb-0">Developer</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="list-group nested-list nested-sortable">
                                    <div class="list-group-item nested-3">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-xs flex-shrink-0 me-3">
                                                <img src="build/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h5 class="fs-md mb-0">Galen Coble</h5>
                                                <p class="text-muted fs-sm mb-0">Backend Developer</p>
                                            </div>
                                        </div>
                                        <div class="list-group nested-list nested-sortable">
                                            <div class="list-group-item nested-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-xs flex-shrink-0 me-3">
                                                        <img src="build/images/users/avatar-7.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-md mb-0">Jean Wood</h5>
                                                        <p class="text-muted fs-sm mb-0">Developer</p>
                                                    </div>
                                                </div>
                                            </div>
