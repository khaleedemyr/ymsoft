...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">See how aspects of the Bootstrap grid system work across
                    ...
                    <table class="table table-bordered table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="6">1.375rem (0.6875rem on each side of a column)</td>
                            </tr>
                            <tr>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use <code>align-items-start</code> class to vertically
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use <code>align-items-center</code> class to vertically
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use <code>align-items-end</code> class to vertically
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use the
                    <code>align-self-start</code>,<code>align-self-center</code>, or
                    <code>align-self-end</code> class respectively to vertically align items with a
                    different position.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use the
                    ...
                    <code>justify-content-end</code> class respectively to horizontally align items
